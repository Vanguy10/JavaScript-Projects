...
function placeXOrO(squareNumber) {
    ...
    //This .some() method is used to check each element of selectedSquae array to 
    ...
    if (!selectedSquares.some(element=>element.includes(squareNumber))) {
        ...
        //This calls a function to check for any wun conditions
        checkWinconditions();
        if (activePlayer ==='X') {
    ...
    function computersTurn() {
        //This booliean is needed for our while loop
        let succes=false;
...
function checkWinconditions() {
    ...
    //This condition checks for tie. If non of the above conditions register and 9 squares
    //selected, the code executes
...
function arrayIncludes(squareA, squareB, squareC) {
    //The next 3 variables will be used to check for a 3 in a row
    const a=selectedSquares.includes(squareA);
    const b=selectedSquares.includes(squareB);
    const c=selectedSquares.includes(squareC);
    //If the 3 variables we pass are all included in our array true is returned and our else if condition executes
    // the drawWinline function
