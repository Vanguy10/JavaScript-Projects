...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand ===true) {
        ...
        //this overwrites Display_Value if the correct value is 0 otherwise it adds onto it
...
function Handle_Operator(Next_Operator) {
    ...
    //number and then store the result in Calculator.First_Operand if it doesnt already exist
